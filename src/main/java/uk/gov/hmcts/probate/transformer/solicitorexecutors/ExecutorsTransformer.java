...
@Primary
/**
 * A class to be used to mutate the response generated by CallbackResponseTransformer.
 * Should NOT be invoked by CallbackResponseTransformer, as is only needed to be invoked when a solicitor
